...
class AdminOrderController extends AdminBase
{
    ...
    public static function actionIndex()
    {
        ...
        // Получаем количество заказов на всём сайте
        $total = Order::getAdminTotalAmountOfOrders();
    ...
    public function actionView($id)
    {
        ...
        // Собираем информацию о конкретном заказе
        $order = Order::getOrderById($id);

        // Получаем массив с идентификаторами и количеством товаров в заказе
