                ...
                <div class="col-lg-4">
                    <div class="login-form">
                        <form action="#" method="post">
                            ...
                            <p>Название</p>
                            <input type="text" name="name" placeholder="" value="<?php echo $category['name']; ?>" required>

                            <p>Порядковый номер</p>
                            <input type="number" min="1" name="sort_order" placeholder="" value="<?php echo $category['sort_order']; ?>" required>
